...
def compare_keys(
    ...
    if (
        ...
        raise ValueError(
            f"{source_table}: Source and Target "
            f"key column counts do not match. "
    ...
    # --------------------------------------------------------
    # Save CSV only when differences exist
    # --------------------------------------------------------
    ...
    if not mismatch_df.empty:
        ...
        mismatch_path = os.path.join(
            OUTPUT_FOLDER,
            f"{source_table}_key_mismatches.csv"
        )
